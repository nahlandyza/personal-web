...
//   return (
//     <section id="projects" className="min-h-screen bg-[#1E1E1E] relative pt-20">
...
//       {/* For Project Contain */}
//       <div className="grid grid-cols-2 mt-17 mx-15">
//         {/* Project 1 */}
//         <div className=" hover:bg-[#FF69B4] transition-colors mx-5">
//           <div className="relative h-43 w-96 mx-auto rounded-2xl border-2 border-[#B0B0B0]">
//             <Image
//               src="/dummy-blog.png"
//               alt="Project 1"
//               fill
...
//             <small className="text-[#B0B0B0] text-2xl font-semibold w-fit ">
//               BLOG
//             </small>
//             <p className="text-white text-xl w-96 text-justify mt-5 mx-3.5">
